...
[s0; 4. Tables&]
[s0;i150;O9; -|4.1 Supported Control Bytes&]
...
[s5; &]
[ {{1353:689:6831:1127<32;h3;@(165)-3 [s0;= [* Supported Control Bytes (C0`-C1)]]
::@2-2 [s0;%- ]
::-1 [s0;%- ]
:: [s0;%- ]
::@(229) [s0;= [*C Mnemonic]]
...
:: [s0;= [C Level 2]]}}&]
[s2; &]
[ {{1104:7743:1153h46;@(165)-2 [s0;= [* Supported Operating System Commands]]
::@2-1 [s0;%- ]
:: [s0;%- ]
::@(229) [s0;= [*C Opcode]]
:: [s0;= [*C Description]]
...
:: [s0;= [C All]]
:: [s0;= [*C@3 19]]
:: [s0; Change selectipn paper color.]
:: [s0;= [C All]]
:: [s0;= [*C@3 104]]
