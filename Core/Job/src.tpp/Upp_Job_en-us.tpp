...
the result. If there was an exception, it is rethrown. Calling 
this method for a worker with void return type is valid.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:Job`:`:Pick`(`): [*@4 T]_[* Pick]()&]
[s2;%% Similar to Get() method. Waits for the work to be finished 
(if necessary), then returns the result but uses pick constructor 
instead of copy constructor to pass the return value. Calling 
this method for a worker with void return type is also valid.&]
[s3; &]
[s3; &]
